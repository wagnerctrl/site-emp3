...
export const metadata: Metadata = {
  title: "Suporte Técnico - PrimeCode Solutions",
  description: "Suporte técnico especializado 24/7 para manter seus sistemas funcionando perfeitamente. Manutenção preventiva e corretiva.",
  keywords: "suporte técnico, manutenção de sistemas, suporte 24/7, help desk, infraestrutura TI",
};
