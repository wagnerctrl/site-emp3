...
import { IconCode, IconBrandReact, IconBrandNextjs, IconBrandNodejs, IconDatabase, IconCloud, IconDeviceDesktop, IconDeviceMobile, IconCheck, IconArrowRight } from "@tabler/icons-react";
import { BackToTop } from "@/components/ui/back-to-top";

export const metadata: Metadata = {
  title: "Desenvolvimento Web - PrimeCode Solutions",
  description: "Criamos sites responsivos, sistemas web e e-commerce com tecnologias modernas. Desenvolvimento profissional para sua empresa.",
  keywords: "desenvolvimento web, sites responsivos, sistemas web, e-commerce, React, Next.js",
};
