...
export const metadata: Metadata = {
  title: "Consultoria Tecnológica - PrimeCode Solutions",
  description: "Consultoria especializada em transformação digital, arquitetura de sistemas e estratégia tecnológica para empresas.",
  keywords: "consultoria tecnológica, transformação digital, arquitetura de sistemas, estratégia tech",
};
