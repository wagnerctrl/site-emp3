...
export const metadata: Metadata = {
  title: "Aplicativos Mobile - PrimeCode Solutions",
  description: "Desenvolvimento de aplicativos móveis nativos e híbridos para iOS e Android. Apps inovadores para sua empresa.",
  keywords: "aplicativos mobile, desenvolvimento iOS, desenvolvimento Android, React Native, Flutter",
};
