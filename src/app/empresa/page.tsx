...
import { IconUsers, IconTarget, IconHeart, IconBriefcase, IconMail, IconPhone, IconMapPin, IconArrowRight, IconCheck, IconStar } from "@tabler/icons-react";
  ...
  const team = [
    {
      name: "João Silva",
      role: "CEO & Fundador",
      description: "15 anos de experiência em tecnologia e gestão de projetos",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=400&auto=format&fit=crop"
    },
    {
      name: "Maria Santos",
      role: "CTO",
      description: "Especialista em arquitetura de software e desenvolvimento full-stack",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-neutral-600 dark:text-neutral-300">
                <p>
                  Fundada em 2019, a PrimeCode Solutions nasceu da visão de democratizar o acesso à tecnologia de qualidade para empresas de todos os tamanhos. Começamos como uma pequena equipe de desenvolvedores apaixonados por criar soluções que realmente fazem a diferença.
                </p>
                <p>
